...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Md. Robiul Hassan", NULL, NULL);
    if (window == NULL)
    {
...
float xOffset = sin(timeValue) * 0.5f; // Moves left and right over time
float yOffset = sin(timeValue) * 0.5f; // Moves up and down over time
/*Time (t):         0     π/2     π     3π/2     2π    ...
sin(t):           0     1       0     -1       0    ...
*/
